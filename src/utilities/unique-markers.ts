...
export function GetDefaultUniqueMarkers(): IUniqueMarkers{
    return {
        level0: 0,
        level1: 0,
        level2: 0,
...
export function IncrementUniqueMarkers(markers: IUniqueMarkers, level: keyof IUniqueMarkers = 'level0', upperLevel: keyof IUniqueMarkers = 'level1'){
...
export function JoinUniqueMarkers(markers: IUniqueMarkers){
    return `${markers.level2}_${markers.level1}_${markers.level0}`;
}

export function GenerateUniqueId(markers: IUniqueMarkers, scope?: string, prefix?: string, suffix?: string){
