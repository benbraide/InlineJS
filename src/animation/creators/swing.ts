...
export type SwingAnimatorCreatorOriginType = 'start' | 'center' | 'end';
...
export function SwingAnimationCreator({ displacement = 5, unit = 'deg', origin: { x = 'start', y = 'start' } = {} }: ISwingAnimationCallbackInfo = {}){
