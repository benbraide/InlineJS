...
function ComputeAndApply(target: HTMLElement, fraction: number, rotateFrom: number, rotateTo: number, fromFactor: number | null, toFactor: number, unit: string, pivot = false){
