...
function CreateLoop_(requestNextLoop, delay, repeats, repeatDelay, duration, resolution = 1) {
    ...
    return new Loop((doWhile, doFinal, doAbort) => call(doWhile, doFinal, doAbort));
}
const knownPeriods = [50, 40, 30, 25, 20, 15, 10, 5, 4, 3, 2, 1, 0];
export function CreateLoop(duration, delay = 1000, repeats = 0, repeatDelay = 0, vsync = true, resolution = 1) {
...
export function CreateAnimationLoop(duration, delay = 1000, repeats = 0, repeatDelay = 0, resolution = 1) {
