...
export function InsertHtml({ element, html, type = 'replace', component, processDirectives = true, afterInsert, afterTransitionCallback, transitionScope }) {
    ...
    if (type === 'replace') { //Remove all child nodes
        let destroyOffspring = (el) => {
            ...
            Array.from(el.children).forEach((child) => {
                ...
                if (elementScope || (ElementScopeKey in child && (elementScope = (_a = global.InferComponentFrom(child)) === null || _a === void 0 ? void 0 : _a.FindElementScope(child)))) {
