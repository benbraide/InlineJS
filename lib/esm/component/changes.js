...
export class Changes {
    ...
    AddGetAccess(path) {
        var _a, _b, _c, _d;
        let targetObject = (((_a = FindComponentById(PeekCurrentComponent() || '')) === null || _a === void 0 ? void 0 : _a.GetBackend().changes) || this);
    ...
    Subscribe(path, handler) {
        var _a;
        let id = (_a = FindComponentById(this.componentId_)) === null || _a === void 0 ? void 0 : _a.GenerateUniqueId('sub_');
