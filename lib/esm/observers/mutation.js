                    ...
                    entries.forEach((entry) => {
                        ...
                        if ((entry === null || entry === void 0 ? void 0 : entry.type) === 'childList') {
                            const pushRemovedNode = (node) => {
                                var _a;
                                const key = GetElementScopeId(((_a = InferComponent(node)) === null || _a === void 0 ? void 0 : _a.GetRoot()) || null);
                                if (key) {
                            ...
                            const key = ((entry.target instanceof HTMLElement) ? GetElementScopeId(((_a = InferComponent(entry.target)) === null || _a === void 0 ? void 0 : _a.GetRoot()) || null) : '');
                            ...
                            const key = ((entry.target instanceof HTMLElement) ? GetElementScopeId(((_b = InferComponent(entry.target)) === null || _b === void 0 ? void 0 : _b.GetRoot()) || null) : '');
