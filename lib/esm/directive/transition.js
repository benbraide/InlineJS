...
export function WaitTransition({ componentId, contextElement, target, callback, onAbort, onPass, reverse, allowRepeats }) {
    var _a, _b, _c, _d;
    if ('WaitTransition' in (target || contextElement) && typeof (target || contextElement)['WaitTransition'] === 'function') {
        return (target || contextElement)['WaitTransition']({ componentId, contextElement, target, callback, onAbort, reverse, allowRepeats });
    }
