...
exports.InvalidateComponentCache = exports.InitComponentCache = exports.GetDefaultCacheValue = void 0;
...
function InvalidateComponentCache(id) {
    (0, cache_1.GetCache)(key_1.ComponentCacheKey, GetDefaultCacheValue).id === id && (0, cache_1.InvalidateCache)(key_1.ComponentCacheKey);
}
exports.InvalidateComponentCache = InvalidateComponentCache;
