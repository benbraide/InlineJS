...
function InsertHtml({ element, html, type = 'replace', component, processDirectives = true, beforeRemove, afterRemove, beforeInsert, afterInsert, afterTransitionCallback, transitionScope, useTransition, sanitize = true }) {
    const componentId = ((typeof component === 'string') ? component : ((component === null || component === void 0 ? void 0 : component.GetId()) || '')), insert = () => {
        ...
        tmpl.innerHTML = sanitize ? dompurify_1.default.sanitize(html) : html;
