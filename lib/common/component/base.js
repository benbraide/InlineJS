...
class BaseComponent extends changes_monitor_1.ChangesMonitor {
    ...
    CreateElementScope(element) {
        ...
        const elementScope = new element_scope_1.ElementScope(this.id_, this.GenerateUniqueId('elscope_'), element, (element === this.root_));
        ...
        const processDirective = (name) => {
            const info = (0, get_attribute_1.FindFirstAttribute)(element, [(0, get_config_1.GetConfig)().GetDirectiveName(name, false), (0, get_config_1.GetConfig)().GetDirectiveName(name, true)]);
            if (info) {
