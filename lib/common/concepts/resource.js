    ...
    Get_(info, concurrent) {
        return new Promise((resolve, reject) => {
            ...
            let getOne = (info) => {
                ...
                let path = (0, path_1.PathToRelative)(info.path, this.origin_);
                if (!path) {
                    return null;
                }
                ...
                let setData = (data) => {
                    ...
                    (_a = this.loadMap_[path].callbacks) === null || _a === void 0 ? void 0 : _a.forEach(callback => (0, try_1.JournalTry)(callback, 'InlineJS.ResourceConcept.SetData'));
