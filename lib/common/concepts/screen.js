...
class ScreenConcept {
    ...
    HandleResize_() {
        var _a, _b;
        (0, add_changes_1.AddChanges)('set', `${this.id_}.size`, 'size', (_a = this.component_) === null || _a === void 0 ? void 0 : _a.GetBackend().changes);
        ...
        if (breakpoint !== oldBreakpoint || checkpoint != oldCheckpoint) { //Marks changed
            (0, add_changes_1.AddChanges)('set', `${this.id_}.sizeMarks`, 'sizeMarks', (_b = this.component_) === null || _b === void 0 ? void 0 : _b.GetBackend().changes);
        }
    }
    HandleScroll_() {
        var _a, _b, _c;
        ...
        (0, add_changes_1.AddChanges)('set', `${this.id_}.scrollOffset`, 'scrollOffset', (_a = this.component_) === null || _a === void 0 ? void 0 : _a.GetBackend().changes);
        let trend = {
        ...
        if (trend.horizontal != this.scrollTrend_.horizontal || trend.vertical != this.scrollTrend_.vertical) {
            (0, add_changes_1.AddChanges)('set', `${this.id_}.scrollTrend`, 'scrollTrend', (_b = this.component_) === null || _b === void 0 ? void 0 : _b.GetBackend().changes);
            this.scrollTrend_ = trend;
        }
        if (delta.x != this.scrollStreak_.horizontal || delta.y != this.scrollStreak_.vertical) {
            (0, add_changes_1.AddChanges)('set', `${this.id_}.scrollStreak`, 'scrollStreak', (_c = this.component_) === null || _c === void 0 ? void 0 : _c.GetBackend().changes);
