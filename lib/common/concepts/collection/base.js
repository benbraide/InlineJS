...
exports.CollectionConcept = void 0;
...
class CollectionConcept {
    constructor(name_, component_, options) {
        ...
        this.keyedProxy_ = (0, create_1.CreateInplaceProxy)((0, create_1.BuildGetterProxyOptions)({
            getter: (prop) => {
                if (prop) {
    ...
    Import({ list, incremental, alertType }) {
        ...
        (0, wait_promise_1.WaitPromise)(list, (list) => {
    ...
    UpdateItem({ index, quantity, entry, incremental, alertType, callback }) {
        ...
        if (!item) { //Initialize item
            if (!entry) { //Invalid item
                return (0, warn_1.JournalWarn)('Cannot update an invalid item.', 'InlineJS.CollectionConcept.UpdateItem');
            }
        ...
        (0, add_changes_1.AddChanges)('set', `${this.id_}.items.${index}.quantity`, 'quantity', (_a = this.component_) === null || _a === void 0 ? void 0 : _a.GetBackend().changes);
        if (callback) {
            callback(item);
        }
    ...
    LeaveQueueMode_() {
        if (this.queuedTasks_) {
            this.queuedTasks_.forEach(task => (0, try_1.JournalTry)(task, 'InlineJS.CollectionConcept.QueuedTask'));
            this.queuedTasks_ = null;
        }
    }
    GetItems_() {
    ...
    AlertUpdate_() {
        var _a;
        (0, add_changes_1.AddChanges)('set', `${this.id_}.items.length`, 'length', (_a = this.component_) === null || _a === void 0 ? void 0 : _a.GetBackend().changes);
        window.dispatchEvent(new CustomEvent(`${this.name_}.update`));
    }
}
exports.CollectionConcept = CollectionConcept;
