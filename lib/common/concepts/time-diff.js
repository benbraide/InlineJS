...
exports.TimeDifferenceConcept = void 0;
const try_1 = require("../journal/try");
class TimeDifferenceConcept {
    constructor() {
        this.checkpoints_ = [
    ...
    Track(_a) {
        ...
        let stopped = false, checkpoint = 0, lastLabel = '', label = '', next = 0, callHandler = () => {
            ...
            requestAnimationFrame(() => (stopped = (stopped || (myCheckpoint == checkpoint && (0, try_1.JournalTry)(() => handler(lastLabel = label)) === false))));
        };
        let pass = () => {
            if (!stopped) {
...
exports.TimeDifferenceConcept = TimeDifferenceConcept;
