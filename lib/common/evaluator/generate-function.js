...
function CallIfFunction(value, handler, componentId, params = []) {
    ...
    if (typeof value === 'function') { //Call function
        const component = (0, find_1.FindComponentById)(componentId || ''), lastContext = component === null || component === void 0 ? void 0 : component.FindProxy(component === null || component === void 0 ? void 0 : component.GetBackend().changes.GetLastAccessContext());
