...
export declare function GenerateValueReturningFunction(expression: string, componentId?: string): any;
export declare function GenerateVoidFunction(expression: string, componentId?: string): any;
