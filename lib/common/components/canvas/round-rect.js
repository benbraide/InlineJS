...
class CanvasRoundRect extends element_1.CanvasBlockElement {
    constructor() {
        var _a;
        ...
        this.ResolveState_();
        this.path_.addEventListener(canvas_1.CanvasRefreshEvent, () => {
            var _a;
            (_a = this.parentElement) === null || _a === void 0 ? void 0 : _a.dispatchEvent(new CustomEvent(canvas_1.CanvasRefreshEvent, {
                bubbles: true,
            }));
        });
    }
...
function CanvasRoundRectCompact() {
    customElements.define((0, get_1.GetGlobal)().GetConfig().GetDirectiveName('canvas-round-rect'), CanvasRoundRect);
}
