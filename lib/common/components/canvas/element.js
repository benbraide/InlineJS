...
exports.CanvasBlockElement = exports.CanvasElement = void 0;
...
class CanvasElement extends HTMLElement {
    ...
    UpdateState_(key, value) {
        if (!this.state_ || (this.state_ && !this.state_.hasOwnProperty(key)) || (0, is_equal_1.IsEqual)(this.state_[key], value)) {
            return false;
        }
...
class CanvasBlockElement extends CanvasElement {
...
exports.CanvasBlockElement = CanvasBlockElement;
