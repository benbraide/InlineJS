                    ...
                    entries.forEach((entry) => {
                        ...
                        if ((entry === null || entry === void 0 ? void 0 : entry.type) === 'childList') {
                            let pushRemovedNode = (node) => {
                                var _a;
                                let key = (0, element_scope_id_1.GetElementScopeId)(((_a = (0, infer_1.InferComponent)(node)) === null || _a === void 0 ? void 0 : _a.GetRoot()) || null);
                                if (key) {
                            ...
                            let key = ((entry.target instanceof HTMLElement) ? (0, element_scope_id_1.GetElementScopeId)(((_b = (0, infer_1.InferComponent)(entry.target)) === null || _b === void 0 ? void 0 : _b.GetRoot()) || null) : '');
