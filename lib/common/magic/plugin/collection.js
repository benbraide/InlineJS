...
exports.BuildCollectionMethods = void 0;
const get_1 = require("../../global/get");
function BuildCollectionMethods(name) {
    const getCollectionConcept = () => (0, get_1.GetGlobal)().GetConcept(name);
    return {
...
exports.BuildCollectionMethods = BuildCollectionMethods;
