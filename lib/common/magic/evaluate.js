...
function EvaluateMagicProperty(component, contextElement, name, prefix = '', checkExternal = true) {
    ...
    let handler = (0, get_1.GetGlobal)().GetMagicManager().FindHandler(nonPrefixedName, { contextElement,
    ...
    if (!handler) {
        ...
        let foundComponent = (0, find_1.FindComponentByName)(nonPrefixedName);
        if (foundComponent) {
