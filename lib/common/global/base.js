...
const native_1 = require("../concepts/fetch/native");
const manager_1 = require("../directives/manager");
const try_1 = require("../journal/try");
const manager_2 = require("../magics/manager");
const base_2 = require("../observers/mutation/base");
...
class BaseGlobal {
    constructor(configOptions, idOffset = 0) {
        ...
        this.mutationObserver_ = new base_2.MutationObserver();
        this.nativeFetch_ = new native_1.NativeFetchConcept();
