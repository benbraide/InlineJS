...
function SubscribeToChanges({ componentId, proxyAccessStorage, callback, subscriptionsCallback, contextElement }) {
    var _a, _b;
    ...
    let subscriptionIds = {}, unsubscribeAll = () => {
        for (const cId in subscriptionIds) {
            const component = (0, find_1.FindComponentById)(cId);
            if (!component) {
                continue;
            }
    ...
    if (contextElement) { // Unsubscribe all when element is destroyed
        (_b = (_a = (0, find_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.FindElementScope(contextElement)) === null || _b === void 0 ? void 0 : _b.AddMarkedCallback(() => {
            cancel();
            unsubscribeAll();
        });
    }
