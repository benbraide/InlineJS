...
(0, mocha_1.describe)('interpolation', () => {
    ...
    (0, mocha_1.it)('should not replace text in child elements', () => __awaiter(void 0, void 0, void 0, function* () {
        const component = (0, create_1.CreateGlobal)().CreateComponent(document.createElement('template')), el = document.createElement('p');
        component.GetRootProxy().GetNative()['name'] = 'John Doe';
        component.GetRootProxy().GetNative()['age'] = 72;
        component.GetRoot().append(el);
    ...
    (0, mocha_1.it)('should not replace text in child elements but should be reactive on parent', () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const component = (0, create_1.CreateGlobal)().CreateComponent(document.createElement('template')), el = document.createElement('p');
        component.GetRootProxy().GetNative()['name'] = 'John Doe';
        component.GetRootProxy().GetNative()['age'] = 72;
        ...
        yield (0, dom_1.waitFor)(() => { (0, chai_1.expect)(el.textContent).equal('I am John Doe and {{ age }} years old.'); });
        // Update 'name' - this should be reactive because it's in a direct text node.
        component.GetRootProxy().GetNative()['name'] = 'Jane Doe';
        yield (0, dom_1.waitFor)(() => { (0, chai_1.expect)(el.textContent).equal('I am Jane Doe and {{ age }} years old.'); });
        ...
        (0, chai_1.expect)(el.textContent).equal('I am Jane Doe and {{ age }} years old.');
        (0, chai_1.expect)((_a = el.querySelector('span')) === null || _a === void 0 ? void 0 : _a.textContent).equal('{{ age }} years');
    }));
});
