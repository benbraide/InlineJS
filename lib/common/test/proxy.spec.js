...
(0, mocha_1.describe)('proxy', () => {
    (0, mocha_1.it)('should be able to be created as root or child', () => {
        let global = (0, create_1.CreateGlobal)(), component = global.CreateComponent(document.createElement('div'));
        let root = component.GetRootProxy(), child = (0, create_child_1.CreateChildProxy)(root, 'one', {}), proxyName = `Proxy<${component.GetId()}>`;
    ...
    (0, mocha_1.it)('should respond to queries', () => {
        let global = (0, create_1.CreateGlobal)(), component = global.CreateComponent(document.createElement('div'));
        let root = component.GetRootProxy(), target = {}, child = (0, create_child_1.CreateChildProxy)(root, 'one', target), proxyName = `Proxy<${component.GetId()}>`;
    ...
    (0, mocha_1.it)('should set, retrieve, and delete values', () => {
        let global = (0, create_1.CreateGlobal)(), component = global.CreateComponent(document.createElement('div')), root = component.GetRootProxy();
