...
(0, mocha_1.describe)('path utility', () => {
    (0, mocha_1.it)('should tidy a path', () => {
        (0, chai_1.expect)((0, path_1.TidyPath)('//path/from//to??arg1=val1&arg2=val2&&arg3==val3')).equal('path/from/to?arg1=val1&arg2=val2&arg3=val3');
        (0, chai_1.expect)((0, path_1.TidyPath)('/path?arg1=val1?arg2=val2')).equal('path?arg1=val1&arg2=val2');
        (0, chai_1.expect)((0, path_1.TidyPath)('/path?arg1=val1?&arg2=val2&?arg3=val3')).equal('path?arg1=val1&arg2=val2&arg3=val3');
        (0, chai_1.expect)((0, path_1.TidyPath)('https:/path?')).equal('https://path');
    });
    (0, mocha_1.it)('should transform an absolute path to a tidied relative path and prepend prefix if available', () => {
        (0, chai_1.expect)((0, path_1.PathToRelative)('https://localhost:300/path', 'https://localhost:300')).equal('/path');
        (0, chai_1.expect)((0, path_1.PathToRelative)('https://localhost:300/path?arg1=val1?&arg2=val2&', 'https://localhost:300')).equal('/path?arg1=val1&arg2=val2');
        (0, chai_1.expect)((0, path_1.PathToRelative)('https://localhost:300/path', 'https://localhost:300', 'ajax')).equal('/ajax/path');
        (0, chai_1.expect)((0, path_1.PathToRelative)('https://localhost:300/path', 'https://localhost:300', '/ajax')).equal('/ajax/path');
    });
