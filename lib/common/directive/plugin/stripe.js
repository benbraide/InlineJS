...
exports.StripeDirectiveHandler = (0, callback_1.CreateDirectiveHandlerCallback)(StripeDirectiveName, ({ componentId, component, contextElement, expression, argKey, argOptions }) => {
    ...
    if (!resolvedComponent || !elementScope) {
        return (0, error_1.JournalError)('Failed to retrieve element scope.', `InlineJS.${StripeDirectiveName}`, contextElement);
    }
    ...
    if (StripeSpecialKeys.includes(argKey)) { //No Stripe binding
        ...
        if (details) {
            ...
            elementScope.SetLocal(localKey, (0, create_1.CreateInplaceProxy)((0, create_1.BuildGetterProxyOptions)({
                getter: (prop) => {
                    var _a;
                    if (prop === 'parent') {
                        return (contextElement.parentElement ? (_a = (0, find_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.FindElementLocalValue(contextElement.parentElement, localKey, true) : null);
                    }
                },
                lookup: ['parent'],
            })));
    ...
    if (argKey in StripeKeys) { //Bind Stripe field
        ...
        elementScope.SetLocal(localKey, (0, create_1.CreateInplaceProxy)((0, create_1.BuildGetterProxyOptions)({
            getter: (prop) => {
                ...
                if (prop === 'error') {
                    (_c = (0, find_1.FindComponentById)(componentId)) === null || _c === void 0 ? void 0 : _c.GetBackend().changes.AddGetAccess(`${id}.${prop}`);
                    return field.error;
                }
                if (prop === 'parent') {
                    return (contextElement.parentElement ? (_d = (0, find_1.FindComponentById)(componentId)) === null || _d === void 0 ? void 0 : _d.FindElementLocalValue(contextElement.parentElement, localKey, true) : null);
                }
                if (prop === 'clear') {
                    return () => {
                        if (field.element) {
        ...
        field.element.on('change', (e) => {
            ...
            if (field.complete) {
                if (field.error) {
                    ...
                    (0, add_changes_1.AddChanges)('set', `${id}.error`, 'error', (_a = (0, find_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes);
                }
                ...
                (0, add_changes_1.AddChanges)('set', `${id}.error`, 'error', (_b = (0, find_1.FindComponentById)(componentId)) === null || _b === void 0 ? void 0 : _b.GetBackend().changes);
        ...
        field.element.on('focus', () => {
            ...
            if (!field.focused) {
                field.focused = true;
                (0, add_changes_1.AddChanges)('set', `${id}.focused`, 'focused', (_a = (0, find_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes);
    ...
    let stripeInstance = null, elements = null, backlog = new Array(), init = () => {
        (0, evaluate_later_1.EvaluateLater)({ componentId, contextElement, expression })((value) => {
            ...
            if (!stripeInstance) {
                return (0, error_1.JournalError)('Failed to initialize stripe', `InlineJS.${StripeDirectiveName}.Init`, contextElement);
            }
            elements = stripeInstance.elements();
            if (!elements) {
                return (0, error_1.JournalError)('Failed to initialize stripe', `InlineJS.${StripeDirectiveName}.Init`, contextElement);
            }
            backlog.splice(0).forEach(callback => (0, try_1.JournalTry)(callback, `InlineJS.${StripeDirectiveName}.Init`, contextElement));
        });
    };
    ...
    let id = resolvedComponent.GenerateUniqueId(`${StripeDirectiveName}_proxy_`), options = (0, options_1.ResolveOptions)({
        options: {
            autofocus: false,
            nexttick: false,
            manual: false,
    ...
    let active = false, complete = false, errorCount = 0, setComplete = (value) => {
        ...
        if (value != complete) {
            complete = value;
            (0, add_changes_1.AddChanges)('set', `${id}.complete`, 'complete', (_a = (0, find_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes);
        }
    };
    let details = { fields, specialMounts, options,
        onReady: () => { var _a; return (0, add_changes_1.AddChanges)('set', `${id}.readyCount`, 'readyCount', (_a = (0, find_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes); },
        onChange: () => {
            var _a;
            ...
            if (currentErrorCount != errorCount) { //Error list changed
                ...
                (0, add_changes_1.AddChanges)('set', `${id}.errors`, 'errors', (_a = (0, find_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes);
            }
        },
    };
    let setActive = (value) => {
    ...
    let evaluate = (0, evaluate_later_1.EvaluateLater)({ componentId, contextElement, expression }), onSuccess = (response) => {
        var _a;
        if (!response.error) {
            ...
            setActive(false);
            if (options.nexttick) {
                (_a = (0, find_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes.AddNextTickHandler(() => evaluate());
            }
    ...
    elementScope.SetLocal(localKey, (0, create_1.CreateInplaceProxy)((0, create_1.BuildProxyOptions)({
        getter: (prop) => {
            ...
            if (prop === 'errors') {
                (_d = (0, find_1.FindComponentById)(componentId)) === null || _d === void 0 ? void 0 : _d.GetBackend().changes.AddGetAccess(`${id}.${prop}`);
...
function StripeDirectiveHandlerCompact() {
    (0, add_1.AddDirectiveHandler)(exports.StripeDirectiveHandler);
}
