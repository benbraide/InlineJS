...
function ProcessDirectives({ component, element, options = {} }) {
    ...
    if (element.hasOwnProperty(element_scope_id_1.ElementScopeKey) && element.hasOwnProperty('OnElementScopeCreated') && typeof element.OnElementScopeCreated === 'function') {
