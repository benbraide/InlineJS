...
class GenericProxy {
    constructor(componentId_, target_, name_, parent, scopeId = null) {
        ...
        const componentId = this.componentId_, isFalseRoot = !!scopeId, path = this.GetPath(), noResultHandler = (component, prop) => {
            ...
            const { context } = component.GetBackend(), isMagic = prop === null || prop === void 0 ? void 0 : prop.startsWith('$');
            if (isMagic) {
        ...
        const isRoot = (!isFalseRoot && !this.parentPath_), self = this, handler = {
            get(target, prop) {
                ...
                return (0, get_prop_1.GetProxyProp)(componentId, self, target, path, prop.toString(), (isRoot ? noResultHandler : undefined));
            },
