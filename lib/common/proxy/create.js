...
exports.BuildGetterProxyOptions = exports.BuildProxyOptions = exports.DisableProxyAction = exports.CreateReadonlyProxy = exports.CreateInplaceProxy = void 0;
        ...
        get(target, prop) {
            ...
            if (!(0, get_1.GetGlobal)().IsNothing(value)) {
                if (alert && (!alert.list || alert.list.includes(prop.toString()))) {
                    (_a = (0, get_1.GetGlobal)().GetCurrentProxyAccessStorage()) === null || _a === void 0 ? void 0 : _a.Put(alert.componentId, `${alert.id}.${prop.toString()}`); //Alert GET access
                }
                return value;
            }
            return Reflect.get(target, prop);
...
exports.CreateInplaceProxy = CreateInplaceProxy;
...
exports.DisableProxyAction = DisableProxyAction;
...
exports.BuildGetterProxyOptions = BuildGetterProxyOptions;
